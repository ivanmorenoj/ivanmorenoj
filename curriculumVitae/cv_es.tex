...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{Desde 2020}{Arquitecto de soluciones IoT}{SEPI ESIME - IPN, Ciudad de M\'exico}{Trabajo creando soluciones de interconectividad con dispositivos de IoT en la nube de AWS utilizando arquitecturas serverless y de microservicios con Kubernetes como parte de mi proyecto de maestr\'ia}
