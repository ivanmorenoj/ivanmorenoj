...
\begin{twenty} % Environment for a list with descriptions
  \twentyitem{Desde 5/22}{Ingeniero DevOps}{Softtek, Ciudad de M\'exico}{Rsponsable de la creaci\'on, mantenimiento, actualizaci\'on y monitoreo de la infraestructura de una aplicaci\'on alojada en la nube de AWS asegurandose la operaci\'on continua}
