...
\cvdate{26 a\~{n}os} % Date of birth
...
\aboutme{M. en C. en Ingenier\'ia de Telecomunicaciones con amplia experiencia en dispositivos IoT, redes de telecomunicaciones, SysAdmin, SRE, DevSecOps y Cloud Computing.}
