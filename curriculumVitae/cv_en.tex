...
% ====== Experience ======
\section*{Experience}
\role{Sr. DevSecOps Engineer — Automation Specialist \& Technical Anchor}{Mar 2024 -- Present}
...
\begin{itemize}
  ...
  \item Architected end-to-end Build Time Container Image Scanning across many CI/CD pipelines, blocking unsafe images from reaching production and measurably reducing the attack surface.
